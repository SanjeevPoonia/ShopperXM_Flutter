...
class SelfAssignScreen extends StatefulWidget {
  ...
  SelfAssignScreen(this.storeID,this.beatPlanID,this.docList);
  FaqState createState() => FaqState();
}

class FaqState extends State<SelfAssignScreen> {
  bool isVisible = true;
  int selectedIndex = -1;
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Text("I have read all the documents carefully and agree on all the Privacy Policy and Terms&Conditions",
                            style: TextStyle(
