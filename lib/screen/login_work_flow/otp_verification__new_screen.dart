...
class OtpVerificationNewScreen extends StatefulWidget{

  final String email;
  final String phone;


  OtpVerificationNewScreen(this.email,this.phone);
  OtpVerificationState createState()=> OtpVerificationState();
}
class OtpVerificationState extends State<OtpVerificationNewScreen> {
...
/*
  ...
  void successVerifyOTPBottomSheet(BuildContext context) {
