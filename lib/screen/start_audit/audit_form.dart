...
import '../audits/view_artifacts_screen.dart';
...
class AuditFormScreen extends StatefulWidget {
  ...
  AuditFormScreen(this.beatPlanID,this.storeID,this.auditType);
  @override
  MenuState createState() => MenuState();
}

class MenuState extends State<AuditFormScreen> {
                        ...
                        GestureDetector(
                            onTap: (){
                              ...
                              if(artifactList.length==0)
                                {
                                  Toast.show("No video/audio found!",
                                ...
                                {
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>ViewArtifactScreen(artifactList)));
                            ...
                            child: Image.asset("assets/art2.png", width: 32, height: 32,color: AppTheme.themeColor)):
                ...
                Expanded(
                  ...
                  ListView(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(selectedScenarioIndex == 9999
                                    ? "Select Scenario"
                      ...
                      SizedBox(height: 17),
                      PhoneTextFieldAuditWidget("Mobile", "Enter mobile",mobileController,phoneValidator),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(selectedAuditTypeIndex == 9999
                                    ? "Select Audit Mode"
                                    : audioModeList[selectedAuditTypeIndex],
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500,
                                      color: Colors.black,
                      ...
                      TextFieldProfileWidget('Audit Type', 'Enter audit type',auditTypeController,auditTypeValidator),
                   ...
                   /*   Container(
                      ...
                      TextFieldProfileWidget('Customer Category', 'Enter here',customerTypeController,customerTypeValidator),
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int pos) {
                        return InkWell(
                          ...
                          child: Container(
                            height: 57,
                            color: selectedScenarioIndex == pos ? Color(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int pos) {
                        return InkWell(
                          ...
                          child: Container(
                            height: 57,
                            color: selectedAuditTypeIndex == pos ? Color(
                                0xFFFF7C00).withOpacity(0.10) : Colors.white,
                            child: Row(
                              children: [
  ...
  getQuestionList(BuildContext context) async {
    ...
    var response = await helper.postAPIWithHeaderProd(
        'getAudit', data, context);
...
//Navigator.push(context, MaterialPageRoute(builder: (context)=>AddressDetailsScreen()));
   ...
   /* else if (selectedCustomerTypeIndex == 9999) {
    ...
    else
      {
        ...
        String scenarioID=scenarioDataList[selectedScenarioIndex]["id"].toString();
        String auditMode=auditModeDataList[selectedAuditTypeIndex]["id"].toString();
      //  String customerTypeID=customerTypeDataList[selectedCustomerTypeIndex]["id"].toString();
        ...
        log("LIST LENGTH "+questionList.length.toString());
           ...
           Navigator.push(context, MaterialPageRoute(
                                        builder: (context) =>
                                            FillAuditScreen(questionList, parentList, storeID, cceName, customerCategoryName, scenarioID, auditMode,"",contactNumber.toString(),widget.beatPlanID,isVideoRequired,isImageRequired,isAudioRequired,widget.auditType)));
