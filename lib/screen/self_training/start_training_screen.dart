...
import 'package:shopperxm_flutter/screen/self_training/start_test_screen.dart';
...
class SelfTrainingScreen extends StatefulWidget {
  ...
  SelfTrainingScreen(this.trainingID);
  @override
            ...
            Expanded(
              ...
              ListView(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>StartTestScreen(widget.trainingID)));
                    },
                    child: Container(
                      height: 61,
