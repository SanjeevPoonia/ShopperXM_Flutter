...
class IncompleteState extends State<IncompleteScreen> {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: Column(
            ...
            children: [
              AppBarWidget("Incompleted Trainings"),
             ...
             // SizedBox(height: 15),
              Expanded(
                ...
                ListView.builder(
                    ...
                    padding: const EdgeInsets.only(bottom: 0,top: 0,left: 16,right: 16),
                    shrinkWrap: true,
                    itemBuilder: (BuildContext context,int pos)
                    {
                      return Column(
                        children: [
                          InkWell(
                            onTap: (){
                              Navigator.push(context, PageTransition(type: PageTransitionType.leftToRight, child: SelfTrainingScreen(trainingList[pos]["training_id"].toString())));
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Expanded(
                                          child: Text(
                                            trainingList[pos]["training_details"],
                                            style: TextStyle(
                                              fontSize: 10.5,
  ...
  void initState() {
    ...
    super.initState();
    getPendingTrainingList(context);
  }

  getPendingTrainingList(BuildContext context) async {
    setState(() {
      isLoading=true;
    });
    var data = {
    ...
    var response = await helper.postAPIWithHeader('getUserPendingTraining', data, context);
